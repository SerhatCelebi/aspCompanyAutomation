...
<body style="background-color: #eaeaea;">
    <form id="form1" runat="server">
        <div class="container" style="width: 25%; background-color: white; margin-top: 90px; border-radius: 10px;">
            ...
            <div class="form-group text-center" style="margin-top: 60px; color: #d5d5d5; font-size: 15px">
                -veya-
            </div>
                ...
                <div class="row text-center">
                        ...
                        <div>
                            <ul class="social-network social-circle">
                                ...
                                <li><a href="https://www.facebook.com/groups/692303501152344/?ref=bookmarks" class="icoFacebook" title="Facebook"><i class="fa fa-facebook"></i></a></li>
