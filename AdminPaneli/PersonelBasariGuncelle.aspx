...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <section class="section">
        <div class="section-header">
            <h1>Personel Başarı Güncelleme Sayfası</h1>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <div class="form-group">
                                <b>Personel Ad Soyad</b><asp:DropDownList ID="DropDownList1" CssClass="form-control" runat="server"></asp:DropDownList>
                            </div>
                            <div class="form-group">
                                <b>ID:</b><asp:TextBox ID="txtID" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <b>Başarı:</b><asp:TextBox ID="txtBasari" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <b>Tarih:</b><asp:TextBox ID="txtTarih" type="date" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                            <div class="form-group">
