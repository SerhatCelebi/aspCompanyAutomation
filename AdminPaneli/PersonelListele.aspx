    ...
    <section class="section">
        ...
        <div class="section-body">
            <div>
                <div class="card">
                    <div class="card-header">
                        <%--<form runat="server">--%>
                        <div>
                            <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control col-md-3" Style="float: left" Placeholder="Ad,Soyad Ara veya ID ara"></asp:TextBox>
                            <asp:Button ID="btnSearch" runat="server" Text="Ara" CssClass="btn btn-primary" Style="float: left; margin-left: -10px" OnClick="btnSearch_Click" />
                        </div>
            ...
            <div style="float: right">
                <cc1:CollectionPager ID="CollectionPager1" runat="server" PageSize="3" BackText="Geri" FirstText="İlk" NextText="İleri" LastText="Son" LabelText="Sayfa" ShowFirstLast="True" ResultsFormat="{0}-{1} arası kayıtlar gösteriliyor.({2} Kayıttan)" ControlCssClass="Sayfalama"></cc1:CollectionPager>
            </div>
            <br />
            <br />
